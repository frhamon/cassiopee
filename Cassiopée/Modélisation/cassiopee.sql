...
CREATE TABLE `icscert` (
  ...
  `name` char(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `fk_icscert_patch` (`patch`),
...
-- Dump completed on 2019-05-20 19:23:47
